...
function getNoteInfo(pageIndex = null) {
    let path = "/TourismManagement/quan-tri-vien/ghi-chu/thong-tin"
    if (pageIndex != null)
        ...
        for (let i = 0; i < data.length; i++) {
            rows += `
                <tr>
                    ...
                    <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">${data[i]['noteSlug']}</span>
                    </td>
...
function getPageAmount() {
    fetch('/TourismManagement/quan-tri-vien/ghi-chu/so-trang')
