...
function getDepartureDateInfo(pageIndex = null) {
    let path = "/TourismManagement/quan-tri-vien/ngay-khoi-hanh/thong-tin"
    if (pageIndex != null)
...
function getPageAmount() {
    fetch('/TourismManagement/quan-tri-vien/ngay-khoi-hanh/so-trang')
...
function getPreviousPage(pageAmount) {
    if (currentPageIndex > 1) {
        ...
        getDepartureDateInfo(currentPageIndex)
    }
    if (currentPageIndex == 1)
        $('#preBtn').hide()
    if (currentPageIndex != 1)
