...
function getServingObjectInfo(pageIndex = null) {
    let path = "/TourismManagement/quan-tri-vien/doi-tuong-phuc-vu/thong-tin"
    if (pageIndex != null)
...
function getPageAmount() {
    fetch('/TourismManagement/quan-tri-vien/doi-tuong-phuc-vu/so-trang')
...
function getPreviousPage(pageAmount) {
    if (currentPageIndex > 1) {
        ...
        getServingObjectInfo(currentPageIndex)
    }
    if (currentPageIndex == 1)
        $('#preBtn').hide()
    if (currentPageIndex != 1)
