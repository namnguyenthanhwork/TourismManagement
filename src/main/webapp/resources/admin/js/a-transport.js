...
function getTransportInfo(pageIndex = null) {
    let path = "/TourismManagement/quan-tri-vien/phuong-tien-di-chuyen/thong-tin"
    if (pageIndex != null)
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch(`/TourismManagement/quan-tri-vien/phuong-tien-di-chuyen/${tranSlug}`, {
                ...
                currentPageIndex = 1
                getPageAmount()
                getTransportInfo(currentPageIndex)
            })
        }
    })
}
...
function getPageAmount() {
    fetch('/TourismManagement/quan-tri-vien/phuong-tien-di-chuyen/so-trang')
