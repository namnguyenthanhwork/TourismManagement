...
function getCategoryInfo(pageIndex = null) {
    let path = "/TourismManagement/quan-tri-vien/loai-tour/thong-tin"
    if (pageIndex != null)
...
function getPageAmount() {
    fetch('/TourismManagement/quan-tri-vien/loai-tour/so-trang')
...
function getPreviousPage(pageAmount) {
    if (currentPageIndex > 1) {
        ...
        getCategoryInfo(currentPageIndex)
    }
    if (currentPageIndex == 1)
        $('#preBtn').hide()
    if (currentPageIndex != 1)
