                ...
                <tr>
                    <td class="text-center">
                        ...
                        <a href="javascript:;" class="badge badge-danger text-capitalize"
                           onclick="deleteSalePercent(${data[i]['sperId']})">Xoá</a>
                    </td>
                    <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">${data[i]['sperId']}</span>
                    </td>
                    <td class="align-middle text-center">
...
function deleteSalePercent(sperId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch(`/TourismManagement/quan-tri-vien/phan-tram-giam-gia/${sperId}`, {
                method: 'delete'
            }).then(res => {
                return res.status
            }).then(data => {
